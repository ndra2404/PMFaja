...
<head>
        ...
        <title>Profile Matching Fajar</title>
                    ...
                    >
                        ...
                        <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                            ...
                            <div class="w-full max-w-[440px] lg:mt-16">
                                <div class="mb-10">
                                    <p class="text-base font-bold leading-normal text-white-dark">PENERAPAN METODE PROFILE MATCHING UNTUK PENGAMBILAN KEPUTUSAN PEMBERIAN DANA BANTUAN PROGRAM KELUARGA HARAPAN</p>
